...
% Compared to demo 9: Oscillations again. 
% But now TFT takes advantage of the increased number of PerCD players.

Strategies = {'TitForTat', 'PerCD', 'Doubler'};
...
print('fig_imi_sim_10', '-dpng', '-r300')